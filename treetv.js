...
settings.createString('UA', 'User-Agent',  'Mozilla/5.0 (Windows NT 6.1; rv:59.0) Gecko/20100101 Firefox/59.0', function(v) {
    service.UA = v;
});
settings.createString('platform', 'Platform',  'Win64', function(v) {
    service.platform = v;
});
